...
function APIModal(props: { setApiKey: any; sidebar?: boolean }) {
  ...
  const isValidKey = (key: string) => {
    // Valis API keys start with 'va-' or are alphanumeric tokens
    // Also accept any non-empty key (user may have custom format)
          ...
          <Card textAlign={'center'}>
            ...
            <ModalBody p="0px">
              <Text
                ...
                mb="22px"
              >
                You need a Valis API Key to access the AI features. Your API Key
                is stored locally on your browser and never sent anywhere else.
                <br />
                <Text as="span" fontWeight="700" color="green.500">
                  No key? You can still chat for free at valischat.xytro.site!
                </Text>
              </Text>
              <Flex mb="20px">
                <Input
                  ...
                  color={inputColor}
                  placeholder="xa-xxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
                ...
                <Button
                  ...
                  onClick={() => {
                    if (isValidKey(inputCode)) {
                      ...
                      toast({
                        title: 'Invalid API key. Please enter a valid Valis API key (min 8 characters).',
                        position: 'top',
                        status: 'error',
                        isClosable: true,
                      });
              ...
              <Link
                ...
                fontWeight="600"
              >
                Get your API key from Xytro Labs
              </Link>
                  ...
                  <AccordionPanel p="18px 0px 10px 0px">
                    <UnorderedList p="5px">
                      <ListItem
                        ...
                        fontWeight="500"
                      >
                        Make sure you have an active Valis API subscription at{' '}
                        <Link
                          href="https://xytro.site"
                          textDecoration="underline !important"
                          color={link}
                      ...
                      <ListItem
                        ...
                        fontWeight="500"
                      >
                        If your key still doesn&apos;t work, contact support at{' '}
                        <Link
